...
DMSPRITEDEF2 "tag" //  Name of the mesh
	...
	BOUNDINGRADIUS 1.12345678
	// The floating point scale of the sprite.
	// Vertex positional values are divided by 2^FPSCALE to get actual positions in game. This is done by Quail
	...
	USEPARAMS2 1
	// The 0x4000 flag. If set, it will use the BOUNDINGBOXMIN and BOUNDINGBOXMAX values.
	// If not set, they will be NULL in game, and the bounding box will be built from the AABB of the mesh
 	 // Argument 1 (%d): The use bounding box flag
	USEBOUNDINGBOX 1
	// The 0x8000 flag. If set, it will use the alpha value of the vertex colors, which generally affects brightness
	// If not set, only the first 3 values, BGR, will be used
 	 // Argument 1 (%d): The use vertex color alpha flag
	USEVERTEXCOLORALPHA 1
	// The 0x10000 flag. If set, the polyhedron reference will not be used, and collision will be built from the geometry of the mesh
	// If not set, a polyhedron will have to be referenced to have collision
